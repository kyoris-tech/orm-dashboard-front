...
export function PlanPricingSection() {
  return (
    <div className="flex flex-col items-center gap-16 w-full max-w-7xl mx-auto">
      ...
      <p className="text-sm text-white/50 text-center max-w-2xl">
        Valores mensais por empresa, sem cobrança por usuário. Currículos além da franquia do plano são cobrados como
        excedente. Planos anuais e condições para volume alto são negociados com a nossa equipe.
      </p>
    </div>
  );
}
